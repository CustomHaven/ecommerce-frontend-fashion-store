...
import { 
    selectWomensBottom, allProductsThunk, 
    selectDisplayMax, productDisplayMax, 
    listWomensBottoms } from "../../../feature/productSlice/productSlice";
...
const AllProducts = (props) => {
    ...
    const allProducts = useSelector(selectWomensBottom);
    ...
    return (
        <>
            ...
            <>
                ...
                <AsideMenu />
                <FeatureProducts products={allProducts} displayMax={displayMax} headerText={"Women's Bottoms"} />
                <Directions />
            </>
        </>   
    );
