...
import { 
    selectWomensTop, allProductsThunk, 
    selectDisplayMax, productDisplayMax, 
    listWomensTop } from "../../../feature/productSlice/productSlice";
...
const AllProducts = (props) => {
    ...
    const allProducts = useSelector(selectWomensTop);
    ...
    return (
        <>
            ...
            <>
                ...
                <AsideMenu />
                <FeatureProducts products={allProducts} displayMax={displayMax} headerText={"Women's Tops"} />
                <Directions />
            </>
        </>   
    );
